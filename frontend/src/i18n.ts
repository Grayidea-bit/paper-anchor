...
const DICT = {
  "zh-TW": {
    ...
    settingsBackupNeedClientId: "請先填入並儲存 Client ID",
    settingsBackupNeedSave: "有未儲存的變更，請先儲存設定",
    ...
    settingsBackupProgress: (phase: string, current: number, total: number) =>
      `${phase} · ${current}/${total}`,
  ...
  en: {
    ...
    settingsBackupNeedClientId: "Fill in and save a Client ID first",
    settingsBackupNeedSave: "You have unsaved changes — save settings first",
