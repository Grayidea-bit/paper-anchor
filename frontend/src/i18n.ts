...
const DICT = {
  "zh-TW": {
    ...
    settingsEmbedTitle: "Embedding 來源",
    settingsEmbedAuto: "自動",
    settingsEmbedNim: "NVIDIA NIM",
    ...
    settingsEmbedReembedConfirmPoint1: "會逐篇重新嵌入全部文獻",
    settingsEmbedReembedConfirmPoint2: "重建期間無法備份或還原",
    settingsEmbedReembedConfirmPoint3: "依文獻數量，需時幾分鐘不等",
    settingsEmbedReembedConfirmOk: "確認重建",
    save: "儲存",
    cancel: "取消",
    saved: "已儲存",
    close: "關閉",
  ...
  en: {
    ...
    reingest: "Reprocess",
    reingestTitle: "Clear stale data and re-parse this paper",
    pdfLoading: "Loading…",
    ...
    settingsEmbedTitle: "Embedding source",
    settingsEmbedAuto: "Auto",
    settingsEmbedNim: "NVIDIA NIM",
    settingsEmbedLocal: "Local model",
    settingsEmbedNote:
    ...
    settingsEmbedReembedConfirmPoint1: "Every paper will be re-embedded one by one",
    settingsEmbedReembedConfirmPoint2: "Backup and restore are unavailable while this runs",
    settingsEmbedReembedConfirmPoint3: "Takes anywhere from minutes depending on how many papers you have",
    settingsEmbedReembedConfirmOk: "Confirm rebuild",
    save: "Save",
    cancel: "Cancel",
    saved: "Saved",
    close: "Close",
    ...
    ariaLibrary: "Library",
    ariaReader: "Paper reader",
    ariaChatPane: "Chat pane",
    ariaRightPane: "Right pane",
    ariaNotesPane: "Notes pane",
    ariaGlossaryPane: "Glossary pane",
  },
} as const;
